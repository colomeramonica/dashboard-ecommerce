  ...
  return (
    <section className="flex flex-col w-full h-full">
      ...
      <div className="flex flex-row justify-between">
        <div>
          <Card className="flex flex-col p-4 max-w-[780] max-h-[500px] bg-white rounded-xl">
        ...
        <div>
          <Card className="flex flex-col p-4 w-[700] h-[500px] bg-white rounded-xl">
            <CardHeader className="font-bold text-xl">
              Produtos mais populares
            </CardHeader>
            <CardBody>
              <PieChart data={mostPopularProducts} size={400} />
            </CardBody>
          </Card>
        </div>
      </div>
